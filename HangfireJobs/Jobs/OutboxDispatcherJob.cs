...
public class OutboxDispatcherJob(IConnection rabbitConnection, ILogger<OutboxDispatcherJob> logger, IAppDbContext context) : IJob
{
    public async Task Execute(CancellationToken cancellationToken)
    {
        ...
        foreach (var msg in outboxes)
        {
            ...
            {
                logger.LogError(ex, "Ошибка при публикации Outbox-сообщения {MsgId}", msg.Id);
                throw;
            }
        }
